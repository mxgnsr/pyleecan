...
def comp_periodicity_geo(self):
    """Compute the geometric periodicity factor of the LamSquirrleCageMag

    This is similar to pyleecan.Classes.Lamination.comp_periodicity_geo method but also
    accounts for the potential holes with magnets.
    ...
    if hasattr(self, "get_Zs"):
        ...
        # add hole periodicity:
        if self.hole:
            for hole in self.hole:
                nb_list.append(hole.Zh)
